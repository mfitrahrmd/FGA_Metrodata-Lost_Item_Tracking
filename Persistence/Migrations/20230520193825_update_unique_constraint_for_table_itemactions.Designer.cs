...
namespace Persistence.Migrations
{
    ...
    [Migration("20230520193825_update_unique_constraint_for_table_itemactions")]
    partial class update_unique_constraint_for_table_itemactions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ItemActions", b =>
                {
                    ...
                    b.HasIndex("ItemId", "ActionId", "EmployeeId")
                        .IsUnique()
                        .HasDatabaseName("ix_item_actions_item_id_action_id_employee_id");
            ...
            modelBuilder.Entity("Domain.Entities.Status", b =>
                {
                    b.Property<Guid>("ItemActionsId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("item_actions_id");
            ...
            modelBuilder.Entity("Domain.Entities.Status", b =>
                {
                    b.HasOne("Domain.Entities.ItemActions", "ItemActions")
                        .WithOne("Status")
                        .HasForeignKey("Domain.Entities.Status", "ItemActionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_status_item_actions_item_actions_id");
